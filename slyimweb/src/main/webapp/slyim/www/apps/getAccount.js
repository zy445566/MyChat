angular.module('getAccount',['ionic', 'getAccount.controller', 'getAccount.service', 'userSetting.service'])
...
.config(function($stateProvider, $urlRouterProvider){
    ...
    .state('getPhone',{
        url:'/getPhone',
        templateUrl:'templates/getAccount/getPhone.html',
        controller:'getPhoneCtrl'   
    })
    .state('changePhone',{
        url:'/changePhone',
        templateUrl:'templates/getAccount/changePhone.html',
        controller:'changePhoneCtrl'   
    })
    .state('accountInfo',{
        url:'/accountInfo',
        templateUrl:'templates/getAccount/accountInfo.html',
        controller:'accountInfoCtrl'   
    });
    $urlRouterProvider.otherwise('/getPhone');
});