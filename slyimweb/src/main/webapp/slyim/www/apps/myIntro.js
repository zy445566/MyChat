angular.module('myIntro', ['ionic', 'myIntro.controller', 'myIntro.service', 'userSetting.service'])
...
.config(function($stateProvider, $urlRouterProvider) {
  $stateProvider
    .state('myInfo', {
    url: '/myInfo/:userId',
    templateUrl: 'templates/myIntro/myInfo.html',
    controller: 'myInfoCtrl'
  });
  $urlRouterProvider.otherwise('/myInfo/0');
});